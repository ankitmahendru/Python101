...
def higher_card(card_one, card_two):
    ...
    3.  '2' - '10' = numerical value.
    """
    card_one_v = value_of_card(card_one)
    card_two_v = value_of_card(card_two)
    if (card_one_v>card_two_v):
        return(card_one)
    elif(card_two_v == card_one_v):
